...
from cloud_vfs.storage.env import archive_cli_arg, archive_from_entry, normalize_archive
...
class MaterializeTests(unittest.TestCase):
    ...
    def test_legacy_archive_spellings_map_to_canonical(self) -> None:
        self.assertEqual(normalize_archive("runpod_staging"), "remote_staging")
        self.assertEqual(archive_cli_arg("runpod_staging"), "remote_staging")
    ...
    def test_ingest_uploads_source_to_target(self) -> None:
        ...
        target_rel = "experiments/runs/model_best.pth"
